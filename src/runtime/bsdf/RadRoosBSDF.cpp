...
void RadRoosBSDF::serialize(const SerializationInput& input) const
{
    ...
    input.Tree.addNumber("rf_r0", *mBSDF, 0);
    input.Tree.addNumber("rf_p", *mBSDF, 0);
    input.Tree.addNumber("rf_q", *mBSDF, 0);
    input.Tree.addNumber("tau_t0", *mBSDF, 0);
    input.Tree.addNumber("tau_p", *mBSDF, 0);
    input.Tree.addNumber("tau_q", *mBSDF, 0);
