...
public:
    ...
    bool copyBufferToHost(const std::string& name, void* dst, size_t sizeInBytes);
    bool copyBufferFromHost(const std::string& name, const void* src, size_t sizeInBytes);
