...
#include "technique/ReSTIRTechnique.h"
...
static std::shared_ptr<Technique> restir_loader(const std::shared_ptr<SceneObject>& obj)
{
    return std::make_shared<ReSTIRTechnique>(*obj);
}
